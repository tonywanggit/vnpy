...
class BollingerBotXBTUSDStrategy(CtaInvestmentTemplate):
    """基于布林通道的交易策略"""
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        """"""
        super(BollingerBotXBTUSDStrategy, self).__init__(
