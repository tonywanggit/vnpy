...
class BollingerBotSM001Strategy(CtaInvestmentTemplate):
    """基于布林通道的交易策略"""
    ...
    # （空头参数）
    shortBollLength = 59  # 通道窗口数
    shortEntryDev = 3.6  # 开仓偏差
    shortExitDev = 0.4  # 平仓偏差
    shortTrailingPrcnt = 1.7  # 移动止损百分比
    shortMaLength = 21  # 过滤用均线窗口
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        """"""
        super(BollingerBotSM001Strategy, self).__init__(
